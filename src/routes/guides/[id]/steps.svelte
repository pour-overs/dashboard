...
<header class="actions">
  ...
  <button type="button" disabled={!hasChanged} on:click={saveChanges}>
    Save Changes
  </button>
    ...
    <Collapsible collapsed={false}>
      ...
      <div slot="content">
        <form
          ...
          <label>
            Grind
            <span class="measurement">fineness</span>
